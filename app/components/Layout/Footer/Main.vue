...
<template>
  <div
    class="main-panel relative overflow-hidden bg-white/65 dark:bg-gradient-to-br dark:from-[#021207]/90 dark:to-[#14532d]/70 border border-green-500/10 shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)]"
  >
    <!-- Decorative elements -->
