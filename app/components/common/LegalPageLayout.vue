...
<template>
  <section
    class="min-h-screen pt-24 pb-12 lg:pt-32 text-gray-800 dark:text-gray-200 transition-colors duration-300 px-6"
  >
    <div class="max-w-3xl mx-auto">
      ...
      <div class="border-b border-gray-200 dark:border-gray-700 pb-6 mb-8">
        <h1
          class="text-3xl md:text-4xl font-bold text-green-700 dark:text-green-400 mb-2"
        >
          {{ data.title }}
        </h1>
      ...
      <!-- Introduction -->
      <div
        class="relative mb-10 bg-green-50 dark:bg-green-900/30 p-5 rounded-lg border-l-4 border-green-500 dark:border-green-600"
      >
      ...
      <div class="space-y-8">
        ...
        >
          <!-- Section Title -->
          <h2
            class="text-2xl font-semibold text-green-600 dark:text-green-400 border-l-4 border-green-500 dark:border-green-400 pl-4 mb-3"
          >
          ...
          <div class="flex items-start">
            <span class="inline-flex mr-2 mt-1 shrink-0">
              <UIcon
                :name="section.icon"
            ...
            <ul
              ...
              class="list-none space-y-3 text-base leading-relaxed"
            >
              <li
                v-for="(item, i) in Array.isArray(section.content)
                  ? section.content
                  : [section.content]"
                :key="i"
            ...
            >
              <template v-if="Array.isArray(section.content)">
                ...
                <p
                  ...
                  v-html="section.content[1]"
                />
                <ul
                  v-if="section.content.length > 2"
                  class="list-none space-y-2 mt-2 pl-6"
                >
                  <li
