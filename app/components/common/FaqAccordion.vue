      ...
      >
        <div v-if="isOpen(index)" class="overflow-hidden">
          <div class="px-6 pb-6 pl-[4.5rem] relative z-10">
            <!-- Decorative Line -->
            <div
              class="absolute left-9 top-0 bottom-6 w-0.5 bg-linear-to-b from-green-300 to-transparent dark:from-green-700 dark:to-transparent"
            />
            ...
            <div
              class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700/50 flex items-center gap-3"
            >
              <span class="text-sm text-gray-500 dark:text-gray-400"
                >Apakah ini membantu?</span
              >
