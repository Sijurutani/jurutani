...
export const faqData: FaqData = {
    ...
    farming: [
        ...
        },
        {
            ...
            answer: 'Tentu saja! JuruTani memiliki kategori khusus untuk pertanian modern termasuk Hidroponik, Aquaponik, dan Urban Farming. Kami memiliki komunitas aktif dan pakar yang spesialis di bidang teknologi pertanian modern ini.'
        },
        {
        ...
        },
        {
            ...
            answer: 'Data cuaca JuruTani terintegrasi dengan data satelit global dan BMKG lokal untuk memberikan prakiraan cuaca tingkat kecamatan. Kami menyediakan info curah hujan, suhu, kelembapan, dan kecepatan angin yang diperbarui setiap jam untuk membantu Anda merencanakan waktu penyemprotan atau pemupukan.'
        },
        {
    ...
    marketplace: [
        ...
        },
        {
            ...
            answer: 'JuruTani menggunakan sistem Rekening Bersama (Escrow) untuk keamanan transaksi. Pembeli mentransfer uang ke rekening resmi JuruTani. Dana akan diteruskan ke Petani setelah Pembeli mengonfirmasi penerimaan barang sesuai pesanan. Ini melindungi kedua belah pihak dari penipuan.'
        },
        {
        ...
        },
        {
            ...
            answer: 'Ya, Marketplace JuruTani juga menyediakan sarana produksi pertanian (saprotan). Kami bermitra dengan produsen dan distributor resmi untuk menjamin keaslian benih, pupuk, dan pestisida yang dijual di platform kami. Hati-hati dengan produk palsu, belilah dari toko bercentang Official atau Terverifikasi.'
        }
    ],
    technical: [
        {
            question: 'Aplikasi sering tertutup sendiri (force close), solusinya?',
            answer: 'Hal ini biasanya disebabkan oleh memori HP yang penuh atau cache aplikasi yang menumpuk. Coba langkah berikut: 1) Hapus Cache aplikasi JuruTani di pengaturan HP. 2) Pastikan ruang penyimpanan internal masih cukup. 3) Update aplikasi ke versi terbaru di Play Store. Jika masih bermasalah, hubungi CS kami.'
        },
        {
            question: 'Bagaimana menghubungkan sensor IoT ke aplikasi?',
            answer: 'Masuk ke menu "Smart Farming", pilih "Tambah Perangkat". Pastikan Bluetooth dan GPS HP Anda menyala. Nyalakan perangkat sensor Anda hingga lampu indikator berkedip. Ikuti petunjuk pairing di layar. Pastikan perangkat sensor Anda kompatibel dengan ekosistem JuruTani.'
        },
        {
            question: 'Mengapa saya tidak menerima notifikasi?',
            answer: 'Periksa pengaturan notifikasi di HP Anda, pastikan izin notifikasi untuk JuruTani sudah diaktifkan. Juga cek pengaturan di dalam aplikasi pada menu Profil > Pengaturan Notifikasi, pastikan jenis notifikasi yang Anda inginkan (misal: Pengingat Jadwal, Chat, Info Harga) sudah dalam posisi ON.'
        },
        {
...
export const quickHelpCards: IconCard[] = [
    {
        ...
        description: 'Pelajari dasar-dasar penggunaan aplikasi JuruTani dari pendaftaran hingga fitur utama.',
    ...
    },
    {
        ...
        description: 'Tonton demonstrasi visual cara memanfaatkan fitur canggih JuruTani untuk lahan Anda.',
        icon: 'i-lucide-video',
        link: '/videos',
        color: 'blue'
    },
