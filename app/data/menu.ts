...
export const footerContactInfo = [
  {
    ...
    text: [
      'Jl. Kusumanegara No.2, Tahunan, Kec. Umbulharjo,',
...
export const footerSocialMedia = [
  {
    name: 'WhatsApp',
    icon: 'i-mdi-whatsapp',
    url: 'https://api.whatsapp.com/send/?phone=6285669000010',
    ariaLabel: 'WhatsApp',
  },
  {
    name: 'TikTok',
    icon: 'i-simple-icons-tiktok',
    url: 'https://www.tiktok.com/@juru_tani',
    ariaLabel: 'TikTok',
  },
  {
    name: 'Email',
    icon: 'i-mdi-gmail',
    url: 'mailto:si.jurutani@gmail.com',
    ariaLabel: 'Email',
  },
  {
    name: 'Instagram',
    icon: 'i-mdi-instagram',
    url: 'https://www.instagram.com/jurutani_',
    ariaLabel: 'Instagram',
  },
  {
    name: 'YouTube',
    icon: 'i-mdi-youtube',
    url: 'https://www.youtube.com/@Juru_Tani',
    ariaLabel: 'YouTube',
  },
]
