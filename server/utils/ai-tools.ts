...
export const CHAT_TOOLS = [
  {
    ...
    function: {
      ...
      description:
        'Dapatkan total pengguna terdaftar (users), termasuk statistik jumlah dari masing-masing role (petani, expert, instuktur, dll).',
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan daftar instruktur (instructors) yang ada di platform.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan ringkasan aktivitas platform hari ini: pengguna baru, kursus baru, berita baru, dan produk pasar baru.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan daftar konten yang belum dipublish / masih berstatus draft: kursus (learning_courses), berita (news_updated), dan produk pasar (product_markets).',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan 10 pengguna terbaru yang mendaftar ke platform Jurutani, termasuk nama, email, dan role.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan daftar kursus (learning_courses) yang belum disetujui — status masih pending.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      name: 'get_user',
      description:
        'Cari data pengguna tertentu berdasarkan nama lengkap atau email. Gunakan ketika user bertanya tentang info spesifik seorang pengguna.',
      parameters: {
        type: 'object',
        properties: {
          query: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan ringkasan keseluruhan platform: total kursus, berita, video, pertemuan, produk pasar, pakar, instruktur, dan pengguna aktif.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan statistik kursus pembelajaran (learning_courses): total keseluruhan, breakdown per status (pending/approved/rejected/archived), dan breakdown per kategori.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan kursus terpopuler atau paling banyak diselesaikan (berdasarkan jumlah completions), beserta judul, kategori, dan rata-rata rating.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan statistik penyelesaian kursus (course_completions): total sertifikat diterbitkan, top 5 kursus dengan penyelesaian terbanyak.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Cari kursus pembelajaran berdasarkan kata kunci judul. Kembalikan daftar kursus yang cocok beserta status dan kategorinya.',
      parameters: {
        type: 'object',
        properties: {
          query: {
  ...
  },
  {
    ...
    function: {
      name: 'get_meetings',
      description:
        'Dapatkan daftar pertemuan/agenda (meetings) yang ada di platform, termasuk judul, organisasi, kategori, dan status.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan statistik pertemuan: total pertemuan, breakdown per kategori, dan jumlah jadwal pertemuan (meeting_schedules).',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      name: 'get_videos',
      description:
        'Dapatkan daftar video YouTube yang ada di platform Jurutani, termasuk judul, kategori, dan link.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan daftar komoditas pangan beserta harga terbaru berdasarkan kategori tertentu (misalnya: sayuran, buah, daging, ikan, bumbu, dll).',
      parameters: {
        type: 'object',
        properties: {
          category: {
            type: 'string',
            description:
              'Kategori pangan yang ingin dicari, misalnya: sayuran, buah, daging, ikan, bumbu.',
          },
        },
        required: ['category'],
      },
  ...
  },
  {
    ...
    function: {
      name: 'search_food',
      description:
        'Cari komoditas pangan berdasarkan nama. Gunakan ketika user bertanya harga atau info spesifik sebuah komoditas (misalnya: harga beras, harga cabai, dll).',
      parameters: {
        type: 'object',
        properties: {
          query: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan daftar produk pasar (product_markets) yang telah dipublish, termasuk nama, kategori, harga, dan penjual.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan statistik produk pasar (product_markets): total produk, breakdown per status, dan breakdown per kategori.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan berita terbaru dari platform (news_updated), termasuk judul, kategori, dan status publikasi.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      name: 'get_news_stats',
      description:
        'Dapatkan statistik berita (news_updated): total berita, breakdown per status (published/pending/draft), dan breakdown per kategori.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      name: 'manage_news',
      description:
        'Kelola data berita (news_updated) untuk aksi create, update, delete (soft delete), dan reject.',
      parameters: {
        type: 'object',
        properties: {
          action: {
            type: 'string',
            description:
              'Aksi yang dijalankan: create | update | delete | reject',
          },
          id: {
            type: 'string',
            description:
              'ID berita. Wajib untuk action update, delete, dan reject.',
          },
          title: {
            type: 'string',
            description:
              'Judul berita. Wajib untuk create, opsional untuk update.',
          },
          category: {
            type: 'string',
            description:
              'Kategori berita. Wajib untuk create, opsional untuk update.',
          },
          sub_title: {
            type: 'string',
          ...
          status_news: {
            type: 'string',
            description:
              'Status berita untuk create/update (misal: pending/published/rejected/draft).',
          },
          reason: {
            type: 'string',
  ...
  },
  {
    ...
    function: {
      name: 'manage_market',
      description:
        'Kelola data produk pasar (product_markets) untuk aksi create, update, delete (soft delete), dan reject.',
      parameters: {
        type: 'object',
        properties: {
          action: {
          ...
          id: {
            type: 'string',
            description:
              'ID produk market. Wajib untuk action update, delete, dan reject.',
          },
          name: {
            type: 'string',
            description:
              'Nama produk. Wajib untuk create, opsional untuk update.',
          },
          category: {
            type: 'string',
            description:
              'Kategori produk. Wajib untuk create, opsional untuk update.',
          },
          seller: {
            type: 'string',
            description:
              'Nama penjual. Wajib untuk create, opsional untuk update.',
          },
          price: {
            type: 'number',
          ...
          status: {
            type: 'string',
            description:
              'Status produk untuk create/update (misal: pending/published/rejected/draft).',
          },
          reason: {
            type: 'string',
            description: 'Alasan reject. Wajib untuk action reject.',
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan daftar pakar berdasarkan kategori keahlian tertentu.',
      parameters: {
        type: 'object',
        properties: {
          category: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan statistik instruktur: total, dan distribusi per provinsi.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan pertumbuhan pengguna baru dalam N hari terakhir (default 7 hari), ditampilkan per hari.',
      parameters: {
        type: 'object',
        properties: {
          days: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan statistik kunjungan (visit_stats) platform dalam beberapa hari terakhir.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan statistik pesan/percakapan (inbox): total percakapan, total pesan, dan jumlah pesan yang belum dibaca.',
      parameters: { type: 'object', properties: {} },
    },
  },
  {
    ...
    function: {
      ...
      description:
        'Dapatkan daftar pengguna yang sudah dihapus/dinonaktifkan dari platform.',
      parameters: { type: 'object', properties: {} },
    },
  },
]
...
export const CORE_TOOLS = CHAT_TOOLS.filter((t) =>
  CORE_TOOL_NAMES.has(
    (t as { type: string; function: { name: string } }).function.name,
  ),
)
...
export async function executeChatTool(
  ...
  if (mutatingTools.has(name)) {
    ...
    if (!currentUser)
      return { error: 'Unauthorized. Login diperlukan untuk aksi ini.' }
  ...
  switch (name) {
    case 'get_users_count': {
      ...
      const stats = data.reduce(
        (acc: Record<string, number>, curr: { role: string | null }) => {
    ...
    case 'get_pending_content': {
      const [coursesRes, newsRes, marketsRes] = await Promise.all([
        ...
        supabase
          .from('news_updated')
          .select('id, title, status_news, created_at')
    ...
    case 'get_top_courses': {
      ...
      return courses
        .map((c) => ({
          ...
          avg_rating: ratingCount[c.id]
            ? +((avgRating[c.id] ?? 0) / ratingCount[c.id]!).toFixed(2)
            : null,
        }))
    ...
    case 'get_course_completions_stats': {
      ...
      if (topIds.length > 0) {
        const { data: courses } = await supabase
          ...
          .in('id', topIds)
        topCourses = (courses ?? [])
          .map((c) => ({ ...c, completions: countMap[c.id] }))
          .sort(
            (a: Record<string, unknown>, b: Record<string, unknown>) =>
              (b.completions as number) - (a.completions as number),
          )
      }
      return {
    ...
    case 'get_meeting_stats': {
      ...
      const byCategory = (
        (meetingsRes.data as Array<{ category: string | null }>) ?? []
    ...
    case 'get_market_products': {
      const { data, error } = await supabase
        .from('product_markets')
        .select(
          'id, name, category, price, price_range, price_unit, seller, status, published_at',
        )
        .eq('status', 'published')
        .is('deleted_at', null)
        .is('archived_at', null)
    ...
    case 'manage_news': {
      ...
      if (!['create', 'update', 'delete', 'reject'].includes(action)) {
        return {
          error:
            'Action manage_news tidak valid. Gunakan: create, update, delete, reject.',
        }
      }
      ...
      if (action === 'create') {
        ...
        if (!title || !category) {
          return {
            error:
              'Untuk create news, parameter title dan category wajib diisi.',
          }
        }
        ...
        if (args.cover_image !== undefined)
          payload.cover_image = args.cover_image
        if (payload.status_news === 'published')
      ...
      if (!id)
        return {
          error:
            'Parameter id wajib diisi untuk update, delete, atau reject news.',
        }
      ...
      if (action === 'update') {
        ...
        if (args.status_news !== undefined) {
          ...
          payload.published_at =
            args.status_news === 'published' ? new Date().toISOString() : null
        }
      ...
      if (!reason)
        return { error: 'Alasan reject wajib diisi pada action reject news.' }
    ...
    case 'manage_market': {
      ...
      if (!['create', 'update', 'delete', 'reject'].includes(action)) {
        return {
          error:
            'Action manage_market tidak valid. Gunakan: create, update, delete, reject.',
        }
      }
      ...
      if (action === 'create') {
        ...
        if (!nameValue || !category || !seller) {
          return {
            error:
              'Untuk create market, parameter name, category, dan seller wajib diisi.',
          }
        }
        ...
        if (args.price_range !== undefined)
          payload.price_range = args.price_range
        if (args.price_unit !== undefined) payload.price_unit = args.price_unit
        if (args.contact_seller !== undefined)
          payload.contact_seller = args.contact_seller
        if (args.excerpt !== undefined) payload.excerpt = args.excerpt
        if (args.thumbnail_url !== undefined)
          payload.thumbnail_url = args.thumbnail_url
      ...
      if (!id)
        return {
          error:
            'Parameter id wajib diisi untuk update, delete, atau reject market.',
        }
      ...
      const reason = args.reason?.trim()
      if (!reason)
        return { error: 'Alasan reject wajib diisi pada action reject market.' }
    ...
    case 'get_user_growth': {
      ...
      return {
        ...
        daily_breakdown: Object.entries(daily).map(([date, count]) => ({
          date,
          count,
        })),
      }
